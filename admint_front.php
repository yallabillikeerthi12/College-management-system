...
if(isset($_POST['login'])){
    ...
    if($data && password_verify($password, $data['password'])){
        ...
        header("Location: admint_front.php");
        exit();
...
<a href="dashboard_front.php" class="back-btn">&larr; Back to dashboard</a>
</div>
<?php } else { ?>
...
<li>
<a href="admint_front.php?logout=true">
...
<img src="admin_front.png" alt="Admin Profile">
