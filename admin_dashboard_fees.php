...
<a href="admin_dashboard_fees.php">
...
<a href="view_student_fees.php?id=<?php echo $row['id']; ?>">
...
<a href="update_student_fees.php?id=<?php echo $row['id']; ?>">
...
<a href="delete_student_fees.php?id=<?php echo $row['id']; ?>"
...
<a href="logout_fees.php" class="logout-btn">
