...
$pinno=$_SESSION['pinno'];
    ...
    $sql = "SELECT * FROM student_fees 
            ...
            AND LOWER(TRIM(pinno)) = LOWER(TRIM('$pinno'))";
...
<div class="box">
    ...
    <form method="POST">
        ...
        <label>PIN NO *</label>
        <input type="text" name="pinno" required placeholder="Enter PIN No">
    ...
    <table>
        ...
        <tr>
            <th>PIN No</th>
            <td><?php echo $studentData['pinno']; ?></td>
        </tr>
        <tr>
            <th>Total Fee</th>
        ...
        <tr>
            <th>Due Fee</th>
            <td><?php echo $studentData['due_fee']; ?></td>
        </tr>
    </table>
